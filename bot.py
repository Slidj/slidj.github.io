...
# Змінна для зберігання шаблону
NEWS_TEMPLATE = ""
TEMPLATE_FILE = "templates/news_template.html"

# Функція для завантаження шаблону
def load_template():
    ...
    try:
        ...
        # Резервний (fallback) шаблон, якщо файл не знайдено
        NEWS_TEMPLATE = (
...
def _fetch_news(params: dict, title_prefix: str) -> dict | None:
    ...
    # ... (код для запиту NewsAPI без змін)
    ...
    try:
        ...
        if data['status'] == 'ok' and data['articles']:
            ...
            # Замінюємо placeholders у шаблоні
        ...
        # ... (решта обробки помилок у _fetch_news без змін)
        else:
...
def publish_endpoint():
    # ... (перевірки та логіка публікації без змін)
