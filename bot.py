...
NEWS_TEMPLATE = None # Шаблон буде завантажено пізніше

# ----------------------------------------------------
# 2. ФУНКЦІЯ ЗАВАНТАЖЕННЯ ШАБЛОНУ (ЗМІНЕНО)
# ----------------------------------------------------
...
def _load_template(file_path="templates/news_template.txt"):
    ...
    try:
        # Відкриваємо файл за новим шляхом: templates/news_template.txt
        ...
        # Використовуємо резервний шаблон, якщо файл не знайдено
        NEWS_TEMPLATE = (
...
if __name__ == '__main__':
    # Завантаження шаблону при запуску
    _load_template() 
