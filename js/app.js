// ============================================================
// 🎬 MEDIA HUB: MAIN CONTROLLER (v1.7.7)
// ============================================================
...
// ... (решта логіки initApp, switchMode, loadContent без змін) ...
    ...
    try {
        ...
        if (tg) {
            ...
            if(tg.initDataUnsafe?.user?.photo_url) {
                ...
                if (avatar && defAvatar) { avatar.src = tg.initDataUnsafe.user.photo_url; avatar.style.display = 'block'; defAvatar.style.display = 'none'; }
            }
        }
        await loadCloudData();
        setupInfiniteScroll(); 
