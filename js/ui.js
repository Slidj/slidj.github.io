        ...
        card.innerHTML = `
            ...
            <div class="card-footer">
                <div class="card-actions">
                     <button class="action-btn share-btn" onclick="window.shareItem('${item.url}', 'News')">📤</button>
        ...
        card.innerHTML = `
            ...
            <div class="movie-info">
                ...
                <div class="movie-actions">
                     <button class="action-btn share-btn" onclick="window.shareItem('${item.url}', 'Movie')">📤</button>
