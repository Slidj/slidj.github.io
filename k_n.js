(function () {
    ...
    // ❗ НОВА ФУНКЦІЯ: Вставляє CSS у HTML
    function setStyles() {
        // Ми створюємо CSS-правила для двох основних типів заголовків у Lampa
        var style = '';
        // Заголовок сторінки плагіна
        style += '.title { color: yellow !important; font-weight: bold !important; }'; 
        // Заголовки під постерами (якщо ви використовуєте PosterWall)
        style += '.poster__name { color: yellow !important; font-weight: bold !important; }'; 
        
        var styleElement = document.createElement('style');
        styleElement.textContent = style;
        
        // Вставляємо його в <head> документа, щоб він застосувався
        document.head.appendChild(styleElement);
    }
    
    // ... (Всі інші глобальні змінні та функції залишаються тут) ...
    
    // Використовуємо ваш оригінальний код і додаємо нову логіку
    ...
    function component(object) {
      // ❗ ВИКЛИК НОВОЇ ФУНКЦІЇ: Застосувати стилі при створенні компонента
      setStyles(); 
      ...
      // ... (Весь інший код компонента залишається без змін) ...
      ...
      this.lifeSource = function() {
        ...
        return new Promise(function(resolve, reject) {
          ...
          var fin = function fin(call) {
            ...
            network.silent(account(url), function(js
